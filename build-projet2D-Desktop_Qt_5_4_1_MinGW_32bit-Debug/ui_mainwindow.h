...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget_2->setGeometry(QRect(400, 40, 241, 151));
        verticalLayout_2 = new QVBoxLayout(verticalLayoutWidget_2);
        verticalLayout_2->setSpacing(6);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        labelImage2 = new QLabel(verticalLayoutWidget_2);
        labelImage2->setObjectName(QStringLiteral("labelImage2"));

        verticalLayout_2->addWidget(labelImage2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelImage2->setText(QApplication::translate("MainWindow", "TextLabel", 0));
    } // retranslateUi
